...
graph TD
    ...
    click F "./src/components/AGENTS.md" "查看 components 模块文档"
    click G "./src/config/AGENTS.md" "查看 config 模块文档"
    click H "./src/content/AGENTS.md" "查看 content 模块文档"
    click I "./src/styles/AGENTS.md" "查看 styles 模块文档"
    click J "./src/lib/AGENTS.md" "查看 lib 模块文档"
    click K "./src/tailwind-plugin/AGENTS.md" "查看 tailwind-plugin 模块文档"
    click C "./Web/AGENTS.md" "查看 Web (VitePress) 模块文档"
```
...
- **2026-06-02**: 全面更新 AGENTS.md 文档，修正语言支持信息（en + zh-cn），补充 Web 模块引用，完善配置文件说明，更新 Mermaid 结构图

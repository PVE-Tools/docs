...
> 快速开始请查看 [使用指南](./index.md)，遇到问题请查看 [常见问题](./faq.md)，深入学习请浏览 [高级教程](../tutorial/index.md)。
...
- 执行前风险提示：高风险操作提供阅读确认 + 输入确认词双重防护。
- 操作前备份：脚本在关键操作前自动创建配置副本到 `/var/backups/pve-tools/`。
- 审计日志：记录核心操作的时间戳与操作对象。
- 回滚引导：失败或误操作时提供已知可行的恢复方案指引。

## 6. 社区与第三方生态

- **FastPVE**：快速部署 VM 的社区模板市场。
- **Community Scripts**：社区贡献的辅助脚本合集。
- **Modules**：第三方 PVE 功能模块市场，支持在线提交与安装。
- 所有第三方工具在集成时都会补充额外的风险确认流程。

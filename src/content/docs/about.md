---
title: About
description: PVE Tools Pro documentation site tech stack and infrastructure information
head:
  - tag: style
    content: |
...
<div class="tech-grid">
  <div class="tech-card">
    ...
    <div class="tech-info">
      ...
      <span class="tech-desc">Static site generation framework for high-performance content sites</span>
    </div>
  </div>
  <div class="tech-card">
    ...
    <div class="tech-info">
      ...
      <span class="tech-desc">Astro official documentation theme with complete component system</span>
    </div>
  </div>
  <div class="tech-card">
    ...
    <div class="tech-info">
      ...
      <span class="tech-desc">Atomic CSS utility classes for rapid responsive UI development</span>
    </div>
  </div>
  <div class="tech-card">
    ...
    <div class="tech-info">
      ...
      <span class="tech-desc">Next-generation frontend build tool for blazing-fast development</span>
    </div>
  </div>
  <div class="tech-card">
    ...
    <div class="tech-info">
      ...
      <span class="tech-desc">Type-safe development language for improved code quality</span>
    </div>
  </div>
  <div class="tech-card">
    ...
    <div class="tech-info">
      ...
      <span class="tech-desc">Global edge network static hosting with automatic CI/CD</span>
    </div>
  </div>
</div>
...
<div class="infra-grid">
  <div class="infra-card">
    ...
    <p><a href="https://pages.cloudflare.com" target="_blank">Cloudflare Pages</a> - Global edge network static hosting, automatic CI/CD, millisecond global access</p>
  </div>
  <div class="infra-card">
    <h3>
    ...
    <p><a href="https://github.com/PVE-Tools/PVE-Tools-9" target="_blank">GitHub</a> - Open source code hosting, version control and collaborative development</p>
  </div>
  <div class="infra-card">
    <h3>
    ...
    <p><a href="https://www.cloudflare.com" target="_blank">Cloudflare</a> - Global DNS resolution, DDoS protection, security acceleration</p>
  </div>
  <div class="infra-card">
    <h3>
    ...
    <p><a href="https://pagefind.app" target="_blank">Pagefind</a> - Client-side full-text search, index generated at build time, zero runtime dependencies</p>
  </div>
</div>

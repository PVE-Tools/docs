...
## Q: 官方网站和安装地址是什么？
A: 官方网站为 `https://pve.oowo.cc`。推荐安装命令为 `bash <(curl -sSL https://pve.oowo.cc/PVE-Tools.sh)`。该入口会按地区自动判断是否使用 GitHub 加速，并让你选择 Go 版本或 Shell 版本；Shell 版本可保存到本地并添加 `pvetools` alias。
